...
namespace data.Migrations
{
    ...
    [Migration("20260427215943_fix_seed_isavailable")]
    partial class fix_seed_isavailable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("data.Entities.OptimizationHourResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ElectricityCashflowDkk")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.Property<decimal>("HeatSuppliedMWh")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
                    ...
                    b.Property<DateTime>("TimeFromUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<decimal>("TotalCo2Kg")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("TotalNetCostDkk")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.HasKey("Id");

                    b.HasIndex("OptimizationRunId", "TimeFromUtc")
                        .IsUnique();

                    b.ToTable("OptimizationHourResults");
                });

            modelBuilder.Entity("data.Entities.OptimizationRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ElectricityPriceSource")
                        .IsRequired()
                        .HasMaxLength(32)
                    ...
                    b.Property<decimal>("TotalElectricityCashflowDkk")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");
            ...
            modelBuilder.Entity("data.Entities.OptimizationUnitHourResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ElectricityMWh")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("HeatProducedMWh")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<decimal>("NetCostDkk")
                        .HasPrecision(18, 4)
                        .HasColumnType("numeric(18,4)");

                    b.Property<int>("OptimizationHourResultId")
                        .HasColumnType("integer");

                    b.Property<int>("ProductionUnitId")
                        .HasColumnType("integer");

                    b.Property<decimal>("ScorePerMWh")
                        .HasPrecision(18, 6)
                    ...
                    b.HasIndex("OptimizationHourResultId", "ProductionUnitId")
                        .IsUnique();

                    b.ToTable("OptimizationUnitHourResults");
                });
            ...
            modelBuilder.Entity("data.Entities.ProductionUnit", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Data = "{\"$type\":\"GasBoiler\",\"GasConsumption\":1.05,\"Name\":\"GB1\",\"ImageUrl\":\"GB1.png\",\"MaxHeatMW\":3,\"ProductionCostPerMWh\":510,\"CO2KgPerMWh\":132,\"ElectricityProducedMW\":0,\"ElectricityConsumedMW\":0,\"IsAvailable\":true,\"OnMaintainance\":false,\"IsConnectedToGrid\":false}",
                            Type = "GasBoiler"
                        },
                        new
                        {
                            Id = 2,
                            Data = "{\"$type\":\"GasBoiler\",\"GasConsumption\":1.08,\"Name\":\"GB2\",\"ImageUrl\":\"GB2.png\",\"MaxHeatMW\":2,\"ProductionCostPerMWh\":540,\"CO2KgPerMWh\":134,\"ElectricityProducedMW\":0,\"ElectricityConsumedMW\":0,\"IsAvailable\":true,\"OnMaintainance\":false,\"IsConnectedToGrid\":false}",
                            Type = "GasBoiler"
                        },
                        new
                        {
                            Id = 3,
                            Data = "{\"$type\":\"GasBoiler\",\"GasConsumption\":1.09,\"Name\":\"GB3\",\"ImageUrl\":\"GB3.png\",\"MaxHeatMW\":4,\"ProductionCostPerMWh\":580,\"CO2KgPerMWh\":136,\"ElectricityProducedMW\":0,\"ElectricityConsumedMW\":0,\"IsAvailable\":true,\"OnMaintainance\":false,\"IsConnectedToGrid\":false}",
                            Type = "GasBoiler"
                        },
                        new
                        {
                            Id = 4,
                            Data = "{\"$type\":\"OilBoiler\",\"OilConsumption\":1.18,\"Name\":\"OB1\",\"ImageUrl\":\"OB1.jpg\",\"MaxHeatMW\":6,\"ProductionCostPerMWh\":690,\"CO2KgPerMWh\":147,\"ElectricityProducedMW\":0,\"ElectricityConsumedMW\":0,\"IsAvailable\":true,\"OnMaintainance\":false,\"IsConnectedToGrid\":false}",
                            Type = "OilBoiler"
                        },
                        new
                        {
                            Id = 5,
                            Data = "{\"$type\":\"GasMotor\",\"GasConsumption\":1.82,\"Name\":\"GM1\",\"ImageUrl\":\"GM1.png\",\"MaxHeatMW\":5.3,\"ProductionCostPerMWh\":975,\"CO2KgPerMWh\":227,\"ElectricityProducedMW\":3.9,\"ElectricityConsumedMW\":0,\"IsAvailable\":true,\"OnMaintainance\":false,\"IsConnectedToGrid\":false}",
                            Type = "GasMotor"
                        },
                        new
                        {
                            Id = 6,
                            Data = "{\"$type\":\"ElectricBoiler\",\"Name\":\"EB1\",\"ImageUrl\":\"EB1.jpg\",\"MaxHeatMW\":6,\"ProductionCostPerMWh\":15,\"CO2KgPerMWh\":0,\"ElectricityProducedMW\":0,\"ElectricityConsumedMW\":6,\"IsAvailable\":true,\"OnMaintainance\":false,\"IsConnectedToGrid\":false}",
                            Type = "ElectricBoiler"
                        });
                });
            ...
            modelBuilder.Entity("data.Entities.OptimizationHourResult", b =>
                {
                    b.HasOne("data.Entities.OptimizationRun", "OptimizationRun")
                        .WithMany("Hours")
            ...
            modelBuilder.Entity("data.Entities.OptimizationUnitHourResult", b =>
                {
                    b.HasOne("data.Entities.OptimizationHourResult", "OptimizationHourResult")
                        .WithMany("UnitResults")
                        .HasForeignKey("OptimizationHourResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OptimizationHourResult");
                });
